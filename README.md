...
![Version: 1.7.0-bb.1](https://img.shields.io/badge/Version-1.7.0--bb.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.3.0](https://img.shields.io/badge/AppVersion-2.3.0-informational?style=flat-square)
...
| tempo.tag | string | `"2.3.0-ubi9"` | Docker image tag |
