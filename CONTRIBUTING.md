...
3. Write tests using [cypress](https://www.cypress.io) and [Conftest](https://conftest.dev) and test deployment following [Development Maintenance](./docs/DEVELOPMENT_MAINTENANCE.md)
